package it.eforhum.corsojava.cap1.SistemaNoleggio.dao;

import java.time.LocalDate;
import java.util.ArrayList;
import java.util.List;

import it.eforhum.corsojava.cap1.SistemaNoleggio.oggetti.Console;
import it.eforhum.corsojava.cap1.SistemaNoleggio.oggetti.Film;
import it.eforhum.corsojava.cap1.SistemaNoleggio.oggetti.Genere;
import it.eforhum.corsojava.cap1.SistemaNoleggio.oggetti.Gioco;
import it.eforhum.corsojava.cap1.SistemaNoleggio.oggetti.Noleggio;
