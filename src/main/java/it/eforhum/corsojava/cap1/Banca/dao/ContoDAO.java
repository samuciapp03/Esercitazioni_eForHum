package it.eforhum.corsojava.cap1.Banca.dao;

import java.util.ArrayList;
import java.util.List;

import it.eforhum.corsojava.cap1.Banca.oggetti.Conto;
import it.eforhum.corsojava.cap1.Banca.oggetti.Movimento;
